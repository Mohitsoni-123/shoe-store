    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="mb-10">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-gray-400">Shopping Cart</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-4 lg:col-span-2">
                ...
                >
                  <div className="flex flex-col gap-5 sm:flex-row">
                    ...
                    <div className="flex flex-1 flex-col">
                      ...
                      {/* FIXED: was using item._id (doesn't exist — cart items have no _id)
                          and a non-existent updateQuantity() function.
                          Now uses product._id + size, matching the CartContext API. */}
                      <div className="mt-5 flex items-center justify-between border-t border-gray-100 pt-4">
                        <div className="flex items-center overflow-hidden rounded-lg border border-gray-300">
                          <button
                            type="button"
                            onClick={() => decreaseQuantity(product._id, item.size, item.quantity)}
                          ...
                          <button
                            type="button"
                            onClick={() => increaseQuantity(product._id, item.size, item.quantity)}
            ...
            <Link to="/products" className="inline-flex items-center pt-3 text-sm font-semibold text-gray-700 hover:text-black">
              ← Continue Shopping
            </Link>
          </div>
          ...
          <div>
            <div className="sticky top-24 rounded-2xl border border-gray-200 bg-white p-6">
              ...
              <p className="mt-4 text-center text-xs text-gray-400">Secure checkout • Free shipping</p>
            </div>
          </div>
        </div>
      </section>
